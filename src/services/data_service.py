...
class DataService:
    ...
    async def create_data(self, data_input: DataCreate, user_id: int) -> Data:
        ...
        data = Data(
            ...
            extra_metadata=data_input.metadata,
    ...
    async def create_data_batch(
        self, batch: DataBatchCreate, user_id: int
    ) -> Dict[str, Any]:
        ...
        for i, item in enumerate(batch.items):
            try:
                await self.create_data(item, user_id)
                success_count += 1
